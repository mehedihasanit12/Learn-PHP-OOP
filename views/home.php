    ...
    <div id="slider" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1800">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/slider 1.jpg" alt="" class="w-100 object-fit-cover" height="550"/>
            ...
            <div class="carousel-item">
                <img src="assets/img/slider 2.jpg" alt="" class="w-100 object-fit-cover" height="550"/>
            ...
            <div class="carousel-item">
                <img src="assets/img/slider 3.jpeg" alt="" class="w-100 object-fit-cover" height="550"/>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="web.php?page=details&&id=<?php echo $blog['id']; ?>" class="btn btn-success">Read More</a>
                        </div>
                    </div>
                </div>
